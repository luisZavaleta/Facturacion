		...
		<div class="content container">
			<div class="row">
				...
				<div class="col-md-4 col-xs-4" style="padding-left: 0px; padding-right: 0px;">
					<img class="logo"
						src=" ../images/factura/logo2-5in.png"
						alt="Logo"/>
				</div>
				<div class="col-md-4 col-xs-4">
					<table class="table">
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td colspan="3" class="c1-text b-right"><span style="visibility:hidden">A</span></td>
								<td class="pedido active b-right">Pedido</td>
								<td class="fecha active">Fecha expedición</td>
							</tr>
							<tr>
								<td class="c1 active ">Nombre:</td>
								<td colspan="3" class="c1-text b-right"><span style="visibility:hidden">A</span></td>
								<td class="b-right"><span style="visibility:hidden">A</span></td>
								<td><span style="visibility:hidden">A</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="c2 c1-text"><span style="visibility:hidden">A</span></td>
								<td class="c3 active">C.P.:</td>
								<td class="c4 c1-text b-right"><span style="visibility:hidden">A</span></td>
								<td rowspan="2" class="b-right"><span style="visibility:hidden">A</span></td>
								<td rowspan="2"><span style="visibility:hidden">A</span></td>
							</tr>
							<tr>
				...
				<div class="col-md-12">
					<table class="table">
						<tbody>
							...
							<tr>
								<td colspan="7"><div style="visibility:hidden; height:300px">A</div></td>
							...
							<tr>
								...
								<td class="b-top"><span style="visibility:hidden">A</span></td>
							</tr>
							<tr>
								<td colspan="4" rowspan="2" class="b-top"><span style="visibility:hidden">A</span></td>
								<td colspan="2" class="active b-top">I.V.A.</td>
								<td class="b-top"><span style="visibility:hidden"><span style="visibility:hidden">A</span></span></td>
							</tr>
							<tr>
				...
				<div class="col-md-12">
					<table class="table">
						<tbody>
							...
							<tr>
								<td style="width: 100%"><span style="visibility:hidden">Si esta factura no se paga a su
									vencimiento generará intereses moratorios del 8% Mensual. Toda
									devolución causará un 20% de cargo por manejo de material.</span></td>
							</tr>
						</tbody>
					</table>
				</div>
						...
						<tbody>
							...
							<tr>
								<td class="b-left break-word">
									<p><span style="visibility:hidden">||1.0|5CF3BE94-351C-D25B-38A9-3BDCFD3E3FE3|2013-12-
										...
										1I2n40qMdiwwAChP3wRDUw=|00001000000202771790||</span></p>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="b-left break-word"><span style="visibility:hidden">||1.0|5CF3BE94-351C-D25B-38A9-3BDCFD3E3FE3|2013-12-
				...
				<div class="col-md-9">
					<table class="table">
						<tbody>
							...
							<tr>
								<td colspan="4"><span style="visibility:hidden">A</span></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="4" class="b-top">
									<strong><span style="visibility:hidden">A</span></strong>
									.
								</td>
							</tr>
							<tr>

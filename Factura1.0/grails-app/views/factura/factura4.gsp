...
table tr.active  td,table tr td.active,table tr td span.active {
	font-weight: bold;
	font-size: 10px;
...
tr.cliente-ubicacion td div.active {
	background-color: #95CEEF;
	font-weight: bold;
	text-align: right;
	padding-right: 2px !important;
		...
		<div class="content container">
			<div class="row">
				...
				<div class="col-md-4 col-xs-4"
					...
					<img class="logo" src=" ../images/factura/logo2-5in.png" alt="Logo" />
				</div>
				<div class="col-md-4 col-xs-4">
					<table class="table">
						<tbody>
